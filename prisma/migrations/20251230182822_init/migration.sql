...
CREATE TABLE "Book" (
    ...
    "description" TEXT,
    "recommandedById" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Book" ADD CONSTRAINT "Book_recommandedById_fkey" FOREIGN KEY ("recommandedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
